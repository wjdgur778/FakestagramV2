...
import com.example.fakestagramV1.LoginActivity
import com.example.fakestagramV1.MainActivity
...
import com.example.fakestagramV1.navigation.model.FollowDTO
...
class UserFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        if (uid == currentUserUid) {
            //My page
            fragmentView?.run {
                account_btn_follow_signout?.text = "SignOut"
    ...
    fun followAlarm(destinaionUid: String) {
        var alarmDTO = AlarmDTO()
        alarmDTO.destinationUid = destinaionUid
